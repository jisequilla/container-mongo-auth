...
# Admin User
MONGODB_ADMIN_USER=${MONGODB_ADMIN_USER:-"xpnova"}
MONGODB_ADMIN_PASS=${MONGODB_ADMIN_PASS:-"novaMongo2018"}

# Application Database User
MONGODB_APPLICATION_DATABASE=${MONGODB_APPLICATION_DATABASE:-"uuaaDB"}
MONGODB_APPLICATION_USER=${MONGODB_APPLICATION_USER:-"uuaaUser"}
MONGODB_APPLICATION_PASS=${MONGODB_APPLICATION_PASS:-"uuaaMongo2018"}
